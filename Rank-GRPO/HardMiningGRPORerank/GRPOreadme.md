...
独立evaluation代码：
指令如下：
python HardMiningGRPO/eval_rerank_hr.py \
  --base_model /workspace/Qwen2_5-1.5B-Instruct \
  --adapter_ckpt ./HardMiningGRPO/ckpt_grpo_candidates_rerank_v3/checkpoint-2000 \
  --eval_jsonl ./HardMiningGRPO/grpo_data_v2/grpo_val.cand.fixed_precise_v2.jsonl \
  --use_chat_template \
  ...
  --shuffle_candidates \
  --seed 42 \
  --out_json ./HardMiningGRPO/ckpt_grpo_candidates_rerank_v3/eval_ckpt2000.json



python HardMiningGRPO/eval_rerank_hr_fast.py \
  --base_model /workspace/Qwen2_5-1.5B-Instruct \
  --adapter_ckpt ./HardMiningGRPO/ckpt_grpo_candidates_rerank_v3/checkpoint-2000 \
  --eval_jsonl ./HardMiningGRPO/grpo_data_v2/grpo_val.cand.fixed_precise_v2.jsonl \
  --use_chat_template \
...
================================================================================
[EVAL DONE] adapter=./HardMiningGRPO/ckpt_grpo_candidates_rerank_v3/checkpoint-2000
  HR@1  = 0.005000
  HR@10 = 0.141500
  samples = 2000
================================================================================
[OK] wrote: ./HardMiningGRPO/ckpt_grpo_candidates_rerank_v3/eval_ckpt2000.json
