...
class SFTConfig:
    # 路径配置
    # [修改点 1] 模型路径改为 Qwen/Qwen2.5-7B-Instruct
    # 如果你是从 HuggingFace 下载，直接填 ID；如果是本地路径，请改为你的本地绝对路径
    ...
    # [修改点 2] 输出文件夹路径，修改为适配 7B 模型的命名
    output_dir = "/workspace/data/llm_ckpt_sft_qwen2.5_7b_balanced"
    ...
    # [建议调整] 7B 模型显存需求大，建议减小 batch_size，增大累积步数
    # 原始配置: batch=8, accum=2 (Total=16) -> 新配置: batch=2, accum=8 (Total=16)
    batch_size = 2              
